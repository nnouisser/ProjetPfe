...
namespace NavKeypad
{
    public class Keypad : MonoBehaviour
    {
        ...
        [Header("Animation")]
        [SerializeField] private GameObject animatedCube;
        public GameObject cubee;
        [SerializeField] private string animationToPlay = "door";
        ...
        private void AccessGranted()
        {
            ...
            // Trigger Animation on another cube only if access is granted
            if (animatedCube != null)
            {
                Animation animation = animatedCube.GetComponent<Animation>();
                if (animation != null)
                {
                    cubee.SetActive(false);
                    animation.Play(animationToPlay); // Play the specified animation
                }
                else
                {
                    Debug.LogWarning("The object AnimatedCube does not have an Animation component attached.");
                }
            }
            else
            {
                Debug.LogWarning("Cannot find the object AnimatedCube.");
            }
        }
    }
}
